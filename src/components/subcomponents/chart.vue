  ...
  <div>
    <el-form :inline="true">
      <el-row>
        ...
        <el-col :span="2">
          <el-form-item>
            <el-button plain @click="detailSetting">详细设置</el-button>
          </el-form-item>
        </el-col>
        <el-col :span="2">
          <el-form-item>
    ...
    >
      <el-form label-width="200px">
        <el-row>
          <el-col :span="10">
            <el-form-item label="X轴在Y轴上的刻度：">
              <el-input v-model="xPosition"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item label="Y轴在X轴上的刻度：">
              <el-input v-model="yPosition"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
