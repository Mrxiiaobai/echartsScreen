<template>
  <el-scrollbar style="height: 100%;left:0 !important;">
    <div class="allcharts">
      ...
      <div id="KbinventoryexamineTable">
        <el-table
          ...
          style="width: 100%;"
        >
          <el-table-column label="待检信息" style="height: 40px;line-height:40px;">
            ...
            <el-table-column prop="2" label="批次" min-width="50%" width="85%"></el-table-column>
            <el-table-column prop="a" label="收货日期" min-width="50%" width="80%"></el-table-column>
            <el-table-column prop="b" label="时间" min-width="50%" width="80%"></el-table-column>
          </el-table-column>
        </el-table>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    getdate() {
      ...
      mui.ajax({
        type: "post",
        url: global.context.webUrl + '/Kbxwldpendget',
        ...
        success: function (e) {
          ...
          for (let i = 0; i < result.table1.length; i++) {
            ...
            let ct2_part_desc = element.tldpend_part
            let ct2_par = element.tldpend_desc
            // let ct2_qty_ship = element.tldpend_desc2
            let ct2_priority = element.tldpend_lot
            let ct2_qty_inv = element.tldpend_rec_date
            let ct2_qty_time = element.tldpend_rec_time
            // let ct2_qty_um = element.tldpend_um
            ...
            tableline['a'] = ct2_qty_inv
            tableline['b'] = ct2_qty_time
          ...
          //             let tableline = {};
          //             tableline[0] = i + 1
          //             tableline[1] = ct1_part_desc
          //             tableline[2] = ct1_par
          //             tableline[3] = ct1_priority
          //             tableline[4] = ct1_qty_time
    ...
    cycledate() {
      console.log('abc')
      var _this = this
      if (document.getElementById("KbinventoryexamineTable") == null) {
        return
      }
      setTimeout(() => {
